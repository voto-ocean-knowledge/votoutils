...
def single():
    ...
    ds = xr.open_dataset("/data/data_l0_pyglider/complete_mission/SEA45/M79/timeseries/mission_timeseries.nc")
    ds = ds.sel(time=slice(ds.time.values[459416], ds.time.values[470647]))#     ds = ds.sel(time=slice(ds.time.values[439416], ds.time.values[470647]))
